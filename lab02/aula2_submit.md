...
Encomenda(número,data realizada, fornecedor)
Fornecedor(nome,numfiscal,endereço,fax,condições pagamento,código interno)

Relações(fornecedor-encomenda, encomenda-produto)
...
```
Fornecedor-Encomenda(Binária,1:N,participação parcial)
Encomenda-Produto(Binária,N:M,participação parcial)
...
![ex_2_1!](ex2_1.jpg "AnImage or PDF file")
...
![ex_2_2!](ex2_2.jpeg "AnImage or PDF file")
...
![ex_2_3!](ex2_3.jpeg "AnImage or PDF file")
...
![ex_2_4a!](Ex2_4.png "AnImage or PDF file")
